...
/** Акцентный цвет с градиентом на темном фоне */
export const onDarkTextAccentGradient = 'var(--on-dark-text-accent-gradient, linear-gradient(45deg, #1A9E32 0%, #04C6C9 100%))';
...
/** Акцентный цвет с градиентом на светлом фоне */
export const onLightTextAccentGradient = 'var(--on-light-text-accent-gradient, linear-gradient(45deg, #0D8523 0%, #0DA8AB 100%))';
...
/** Инвертированный акцентный цвет с градиентом */
export const inverseTextAccentGradient = 'var(--inverse-text-accent-gradient, linear-gradient(45deg, #0D8523 0%, #0DA8AB 100%))';
...
/** Акцентный фон поверхности/контрола с градиентом на светлом фоне */
export const onLightSurfaceAccentGradient = 'var(--on-light-surface-accent-gradient, linear-gradient(45deg, #1A9E32 0%, #04C6C9 100%))';
...
/** Инвертированный акцентный фон поверхности/контрола с градиентом */
export const inverseSurfaceAccentGradient = 'var(--inverse-surface-accent-gradient, linear-gradient(45deg, #1A9E32 0%, #04C6C9 100%))';
...
export const onDarkOverlayGradientUp = 'var(--on-dark-overlay-gradient-up, linear-gradient(0deg, rgba(8, 8, 8, 0.00) 0%, rgba(8, 8, 8, 0.01) 0.77%, rgba(8, 8, 8, 0.04) 1.54%, rgba(8, 8, 8, 0.08) 2.31%, rgba(8, 8, 8, 0.15) 3.08%, rgba(8, 8, 8, 0.23) 3.86%, rgba(8, 8, 8, 0.33) 4.63%, rgba(8, 8, 8, 0.44) 5.4%, rgba(8, 8, 8, 0.56) 6.17%, rgba(8, 8, 8, 0.67) 6.94%, rgba(8, 8, 8, 0.77) 7.71%, rgba(8, 8, 8, 0.85) 8.48%, rgba(8, 8, 8, 0.92) 9.25%, rgba(8, 8, 8, 0.96) 10.02%, rgba(8, 8, 8, 0.99) 10.8%, #080808 11.57%))';

export const onDarkOverlayGradientDown = 'var(--on-dark-overlay-gradient-down, linear-gradient(180deg, rgba(8, 8, 8, 0.00) 0%, rgba(8, 8, 8, 0.01) 0.95%, rgba(8, 8, 8, 0.04) 1.9%, rgba(8, 8, 8, 0.08) 2.86%, rgba(8, 8, 8, 0.15) 3.81%, rgba(8, 8, 8, 0.23) 4.76%, rgba(8, 8, 8, 0.33) 5.71%, rgba(8, 8, 8, 0.44) 6.67%, rgba(8, 8, 8, 0.56) 7.62%, rgba(8, 8, 8, 0.67) 8.57%, rgba(8, 8, 8, 0.77) 9.52%, rgba(8, 8, 8, 0.85) 10.48%, rgba(8, 8, 8, 0.92) 11.43%, rgba(8, 8, 8, 0.96) 12.38%, rgba(8, 8, 8, 0.99) 13.33%, #080808 14.29%))';
...
export const inverseOverlayGradientUp = 'var(--inverse-overlay-gradient-up, linear-gradient(0deg, rgba(249, 249, 249, 0.00) 0%, rgba(249, 249, 249, 0.01) 0.77%, rgba(249, 249, 249, 0.04) 1.54%, rgba(249, 249, 249, 0.08) 2.31%, rgba(249, 249, 249, 0.15) 3.08%, rgba(249, 249, 249, 0.23) 3.86%, rgba(249, 249, 249, 0.33) 4.63%, rgba(249, 249, 249, 0.44) 5.4%, rgba(249, 249, 249, 0.56) 6.17%, rgba(249, 249, 249, 0.67) 6.94%, rgba(249, 249, 249, 0.77) 7.71%, rgba(249, 249, 249, 0.85) 8.48%, rgba(249, 249, 249, 0.92) 9.25%, rgba(249, 249, 249, 0.96) 10.02%, rgba(249, 249, 249, 0.99) 10.8%, #F9F9F9 11.57%))';

export const inverseOverlayGradientDown = 'var(--inverse-overlay-gradient-down, linear-gradient(180deg, rgba(249, 249, 249, 0.00) 0%, rgba(249, 249, 249, 0.01) 0.95%, rgba(249, 249, 249, 0.04) 1.9%, rgba(249, 249, 249, 0.08) 2.86%, rgba(249, 249, 249, 0.15) 3.81%, rgba(249, 249, 249, 0.23) 4.76%, rgba(249, 249, 249, 0.33) 5.71%, rgba(249, 249, 249, 0.44) 6.67%, rgba(249, 249, 249, 0.56) 7.62%, rgba(249, 249, 249, 0.67) 8.57%, rgba(249, 249, 249, 0.77) 9.52%, rgba(249, 249, 249, 0.85) 10.48%, rgba(249, 249, 249, 0.92) 11.43%, rgba(249, 249, 249, 0.96) 12.38%, rgba(249, 249, 249, 0.99) 13.33%, #F9F9F9 14.29%))';
...
/** Акцентный цвет обводки с градиентом на темном фоне */
export const onDarkOutlineAccentGradient = 'var(--on-dark-outline-accent-gradient, linear-gradient(45deg, #1A9E32 0%, #04C6C9 100%))';
...
/** Акцентный цвет обводки с градиентом на светлом фоне */
export const onLightOutlineAccentGradient = 'var(--on-light-outline-accent-gradient, linear-gradient(45deg, #0D8523 0%, #0DA8AB 100%))';
...
/** Инвертированный акцентный цвет обводки с градиентом */
export const inverseOutlineAccentGradient = 'var(--inverse-outline-accent-gradient, linear-gradient(45deg, #0D8523 0%, #0DA8AB 100%))';
