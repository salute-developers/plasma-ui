...
/** Акцентный цвет с градиентом */
export const textAccentGradient = 'var(--text-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный цвет с градиентом на темном фоне */
export const onDarkTextAccentGradient = 'var(--on-dark-text-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный цвет с градиентом на светлом фоне */
export const onLightTextAccentGradient = 'var(--on-light-text-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Инвертированный акцентный цвет с градиентом */
export const inverseTextAccentGradient = 'var(--inverse-text-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный фон поверхности/контрола с градиентом */
export const surfaceAccentGradient = 'var(--surface-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный фон поверхности/контрола с градиентом на темном фоне */
export const onDarkSurfaceAccentGradient = 'var(--on-dark-surface-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный фон поверхности/контрола с градиентом на светлом фоне */
export const onLightSurfaceAccentGradient = 'var(--on-light-surface-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Инвертированный акцентный фон поверхности/контрола с градиентом */
export const inverseSurfaceAccentGradient = 'var(--inverse-surface-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный цвет обводки с градиентом */
export const outlineAccentGradient = 'var(--outline-accent-gradient, linear-gradient(45.00deg,rgb(95,65,217)0%,rgb(167,77,231)100%))';
...
/** Акцентный цвет обводки с градиентом на темном фоне */
export const onDarkOutlineAccentGradient = 'var(--on-dark-outline-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Акцентный цвет обводки с градиентом на светлом фоне */
export const onLightOutlineAccentGradient = 'var(--on-light-outline-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
...
/** Инвертированный акцентный цвет обводки с градиентом */
export const inverseOutlineAccentGradient = 'var(--inverse-outline-accent-gradient, linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%))';
