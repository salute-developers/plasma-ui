...
/** Акцентный цвет с градиентом */
export const textAccentGradient = 'var(--text-accent-gradient, linear-gradient(45.00deg, rgb(33, 202, 154) 0%, rgb(74, 214, 252) 100%))';
...
/** Акцентный цвет с градиентом на темном фоне */
export const onDarkTextAccentGradient = 'var(--on-dark-text-accent-gradient, linear-gradient(45.00deg, rgb(33, 202, 154) 0%, rgb(74, 214, 252) 100%))';
...
/** Акцентный цвет с градиентом на светлом фоне */
export const onLightTextAccentGradient = 'var(--on-light-text-accent-gradient, linear-gradient(45.00deg, rgb(5, 153, 111) 0%, rgb(27, 160, 227) 100%))';
...
/** Инвертированный акцентный цвет с градиентом */
export const inverseTextAccentGradient = 'var(--inverse-text-accent-gradient, linear-gradient(45.00deg, rgb(5, 153, 111) 0%, rgb(27, 160, 227) 100%))';
...
/** Акцентный фон поверхности/контрола с градиентом */
export const surfaceAccentGradient = 'var(--surface-accent-gradient, linear-gradient(45.00deg, rgb(0, 172, 123) 0.763%, rgb(39, 198, 229) 100%))';
...
/** Акцентный фон поверхности/контрола с градиентом на темном фоне */
export const onDarkSurfaceAccentGradient = 'var(--on-dark-surface-accent-gradient, linear-gradient(45.00deg, rgb(0, 172, 123) 0.763%, rgb(39, 198, 229) 100%))';
...
/** Акцентный фон поверхности/контрола с градиентом на светлом фоне */
export const onLightSurfaceAccentGradient = 'var(--on-light-surface-accent-gradient, linear-gradient(45.00deg, rgb(0, 172, 123) 0.763%, rgb(39, 198, 229) 100%))';
...
/** Инвертированный акцентный фон поверхности/контрола с градиентом */
export const inverseSurfaceAccentGradient = 'var(--inverse-surface-accent-gradient, linear-gradient(45.00deg, rgb(0, 172, 123) 0.763%, rgb(39, 198, 229) 100%))';
...
/** Акцентный цвет обводки с градиентом */
export const outlineAccentGradient = 'var(--outline-accent-gradient, linear-gradient(45.00deg, rgb(33, 202, 154) 0%, rgb(74, 214, 252) 100%))';
...
/** Акцентный цвет обводки с градиентом на темном фоне */
export const onDarkOutlineAccentGradient = 'var(--on-dark-outline-accent-gradient, linear-gradient(45.00deg, rgb(33, 202, 154) 0%, rgb(74, 214, 252) 100%))';
...
/** Акцентный цвет обводки с градиентом на светлом фоне */
export const onLightOutlineAccentGradient = 'var(--on-light-outline-accent-gradient, linear-gradient(45.00deg, rgb(5, 153, 111) 0%, rgb(27, 160, 227) 100%))';
...
/** Инвертированный акцентный цвет обводки с градиентом */
export const inverseOutlineAccentGradient = 'var(--inverse-outline-accent-gradient, linear-gradient(45.00deg, rgb(5, 153, 111) 0%, rgb(27, 160, 227) 100%))';
...
export const dataDefaultDataGreenGradient = 'var(--data-default-data-green-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 99.975%, #F5F5F58F 99.975%))';
...
export const dataDefaultDataGreenGrayGradient = 'var(--data-default-data-green-gray-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 28.673%, #27C6E5CC 44.083%, #F5F5F58F 99.975%))';
...
export const dataOnDarkDataGreenGradient = 'var(--data-on-dark-data-green-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 99.975%, #F5F5F58F 99.975%))';
...
export const dataOnDarkDataGreenGrayGradient = 'var(--data-on-dark-data-green-gray-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 28.673%, #27C6E5CC 44.083%, #F5F5F58F 99.975%))';
...
export const dataOnLightDataGreenGradient = 'var(--data-on-light-data-green-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 99.975%, #F5F5F58F 99.975%))';
...
export const dataOnLightDataGreenGrayGradient = 'var(--data-on-light-data-green-gray-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 28.673%, #27C6E5CC 44.083%, #F5F5F58F 99.975%))';
...
export const dataInverseDataGreenGradient = 'var(--data-inverse-data-green-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 99.975%, #F5F5F58F 99.975%))';
...
export const dataInverseDataGreenGrayGradient = 'var(--data-inverse-data-green-gray-gradient, linear-gradient(135deg, #00AC7B 0.025%, #14B9B0 28.673%, #27C6E5CC 44.083%, #F5F5F58F 99.975%))';
